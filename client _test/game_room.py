...
SIZE_FONT_DIALOGUE = int(0.0650 * WIN_HEIGHT)
...
class Game_room(Scene):
    ...
    def blit_dialogue_summary_and_get_reward(self):
        ...
        if this_win:
            ...
            text_old_badge = Set.get_text(old_badge, SIZE_FONT_DIALOGUE, COLOR_FONT_DIALOGUE, COLOR_WHITE, "Arial rounded MT bold")
            text_old_badge.set_colorkey(COLOR_WHITE)
            Set.blit(text_old_badge, POSITION_OLD_BADGE, mode="center")
            text_old_score = Set.get_text(str(old_score), SIZE_FONT_DIALOGUE, COLOR_FONT_DIALOGUE, COLOR_WHITE, "Arial rounded MT bold")
            text_old_score.set_colorkey(COLOR_WHITE)
            Set.blit(text_old_score, POSITION_OLD_SCORE, mode="center")
            text_new_badge = Set.get_text(new_badge, SIZE_FONT_DIALOGUE, COLOR_FONT_DIALOGUE, COLOR_WHITE, "Arial rounded MT bold")
            text_new_badge.set_colorkey(COLOR_WHITE)
            Set.blit(text_new_badge, POSITION_NEW_BADGE, mode="center")
            text_new_score = Set.get_text(str(new_score), SIZE_FONT_DIALOGUE, COLOR_FONT_DIALOGUE, COLOR_WHITE, "Arial rounded MT bold")
